...
![Instance Segmentation Sample](assets/ex_1.png)
![Instance Segmentation Sample](assets/ex_2.png)
...
* Here is the updated pycocotools in the ```mask_rcnn/coco-master/PythonAPI/pycocotools```
